  ...
  return (
    <Dialog isOpen={isOpen} onClose={onClose} color={TILE_REGISTRY[TEAMS[selectedTeam]].border}>
      <div className='flex flex-col w-full h-full gap-2 items-start pointer-events-auto'>
        ...
        <p className='text-md'>
          During the entire duration of the game, each flipped tile will earn you potential $FLIP tokens. There are two
          types of tiles: Powerup and normal tiles. Powerup tiles are rarer and unflippable, while normal tiles can get
          flipped back by bots. <br />
          <br />
        ...
        <span className='text-xs opacity-80 mb-2'>
          *Time lock check is done based on block timestamp. You might need to wait a bit after the game ends to submit
          your claim.
        </span>
